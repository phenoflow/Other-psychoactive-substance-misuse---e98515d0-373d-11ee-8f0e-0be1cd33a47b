...
(async () => {
  ...
  await fs.writeFile("other-psychoactive-substance-misuse-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("other-psychoactive-substance-misuse-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
